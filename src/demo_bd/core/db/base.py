...
from demo_bd.core.db.types import (
    GUID,
...
# POG = DeclarativeBase have a conflict with sa_manager.get_bind_mappers_metadata() in alembic env.py
# class UUIDv7AuditBase(CommonTableAttributes, UUIDv7PrimaryKey, AuditColumns, DeclarativeBase):
class UUIDv7AuditBase(CommonTableAttributes, UUIDv7PrimaryKey, AuditColumns):
    """Base for declarative models with UUID primary keys and audit columns."""
