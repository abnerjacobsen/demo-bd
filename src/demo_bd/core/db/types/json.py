"""Custom JSON types for SQLAlchemy dialects.

Provides Oracle Binary JSON and a cross-dialect JsonB type.
"""
...
from demo_bd.core.db._serialization import decode_json, encode_json
...
JsonB = (
    _JSON()
    .with_variant(PG_JSONB, "postgresql")
    .with_variant(ORA_JSONB, "oracle")
    .with_variant(PG_JSONB, "cockroachdb")
)
